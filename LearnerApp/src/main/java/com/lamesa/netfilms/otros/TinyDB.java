...
public class TinyDB {
    ...
    public List<modelFilm> getListObject(String key, Class<?> mClass) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<modelFilm> objects = new ArrayList<>();

        for (String jObjString : objStrings) {
            Object value = gson.fromJson(jObjString, mClass);
            objects.add((modelFilm) value);
        }
        return objects;
    }


    public List<modelFilm> getListObjectContenido(String key, Class<?> mClass) {
        Gson gson = new Gson();
   ...
   public void putListObject(String key, List<modelFilm> objArray){
   	checkForNullKey(key);
    	Gson gson = new Gson();
