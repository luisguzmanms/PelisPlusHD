package com.lamesa.netfilms.video.view;
...
public class SmileView extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mBorderPaint.setShader(new LinearGradient(0, 0, mWidth, mHeight, ContextCompat.getColor(getContext(), R.color.learn_colorPrimary), ContextCompat.getColor(getContext(), R.color.learn_colorPrimaryDark), Shader.TileMode.MIRROR));
        mFacePaint.setShader(new LinearGradient(0, 0, mWidth, mHeight, ContextCompat.getColor(getContext(), R.color.learn_colorPrimaryDark), ContextCompat.getColor(getContext(), R.color.learn_colorPrimary), Shader.TileMode.MIRROR));
